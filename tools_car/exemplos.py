...
cod_exemplo_AutoClip = '''
params = {'path' : r'', #pasta dos vetores
            'mask' : bacias.source(), #camada mascara
            'output' : r''} #pasta de saída

teste = AutoClip(params)
teste.run('UF',merge=True)
'''